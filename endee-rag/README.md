...
endee/ │ ├── endee-rag-gemini/ │ ├── backend/ │ ├── frontend/ │ ├──
data/ │ └── README.md
...
git clone https://github.com/`<your-username>`{=html}/endee.git\
cd endee/endee-rag-gemini
...
Built on Endee (Apache License 2.0).
